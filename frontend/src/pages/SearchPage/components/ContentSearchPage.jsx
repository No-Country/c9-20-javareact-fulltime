...
import {
  ButtonSearchStyled,
  FormStyled,
} from "../../home/styled-components/layout.styled";

import useSearch from "../../home/hook/useSearch";
import NavSide from "../../../components/NavSide";
import search from "../../../../public/icons/search.svg";
import { NavLink } from "react-router-dom";
import { SearchContainerStyled, MessageSearchStyled } from "../styled-components/SearchPage.styled";
      ...
      <SearchContainerStyled>
        <Div gap={"7em"} padding='4em 0'>
          {isSuccess ? (
            ...
            <div
              style={{ height: "50vh", margin: "4em auto", padding: "0 2em", maxWidth: "530px", textAlign: "center" }}>loading...</div>
          )
          }
        </Div>
      </SearchContainerStyled>
