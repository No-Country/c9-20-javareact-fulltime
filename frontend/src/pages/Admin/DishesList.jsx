        ...
        <div className="items">
          ...
          {id == "Churrasqueria" && (
            <>
              <div className="items-container">
                <div className="item line">
                  <p className="dish">Churrasqueria</p>
                  <div className="item-icons">
                    <svg
                      width="22px"
                      viewBox="0 0 18 18"
