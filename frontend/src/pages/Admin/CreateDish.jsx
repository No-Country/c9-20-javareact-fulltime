...
const CreateDish = () => {
  ...
  const [datos, setDatos] = useState({"name":"", "description": "", "price":"","categoryId":""})
  ...
  const handleChange = (e) => {
    if(e.target.name === 'categoryId'){
      setDatos({...datos, "categoryId":e.target.options[e.target.selectedIndex].id})
    } else{
  ...
  const handleUploadClick = () => {
    ...
    axios
        .post("http://localhost:8080/api/dishes", formData, {
            headers: {
