...
const Checkout = () => {
  ...
  if (userAddress.includes("undefined")) {
    console.log(userAddress);
    // userAddress = "No tienes dirección!, ve a mi cuenta";
    console.log(userAddress);
  }
            ...
            <>
              <ContainerInputsStyled>
                <Input
                  ...
                  inlineSize="clamp(200px,80%,676px)"
                  bottom="-23%"
                  register={{
                    ...register("number", {
                ...
                <Input
                  ...
                  name="dueDate"
                  placeholder="MM/YY"
                  inlineSize="clamp(200px,80%,220px)"
                  bottom="-23%"
                  register={{
                ...
                <Input
                  ...
                  inlineSize="clamp(200px,80%,233px)"
                  bottom="-22%"
                  register={{
                    ...register("cvv", {
                      required: "Campo requerido",
